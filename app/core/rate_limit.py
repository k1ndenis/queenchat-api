...
REACTION_EVENTS = Limit("reaction-events", 60, 60)
COMMENT_EVENTS = Limit("comment-events", 30, 60)
INVITE_CREATE = Limit("invite-create", 10, 3600)
WS_EVENTS = Limit("ws-events", 60, 10)
ADMIN_READ = Limit("admin-read", 120, 60)
ADMIN_MUTATION = Limit("admin-mutation", 30, 60)
